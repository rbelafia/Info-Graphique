...
{
    setModelMatrix(HierarchicalRenderable::computeTotalParentTransform());
}
...
{
    if(m_parent) return (m_parent->HierarchicalRenderable::computeTotalParentTransform() * m_parentTransform);
